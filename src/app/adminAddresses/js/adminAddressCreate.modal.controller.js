...
function AdminAddressCreateModalController($timeout, $uibModalInstance, $exceptionHandler, $scope, OrderCloudSDK, ocGeography) {
    var vm = this;
    vm.adminAddress = {
    ...
    vm.submit = function () {
        vm.loading = OrderCloudSDK.AdminAddresses.Create(vm.adminAddress)
