...
function PromotionEditModalController($uibModalInstance, sdkOrderCloud, SelectedPromotion, SelectedBuyerID) {
    var vm = this;
    ...
    vm.submit = function() {
        vm.loading = sdkOrderCloud.Promotions.Update(SelectedPromotion.ID, vm.promotion)
