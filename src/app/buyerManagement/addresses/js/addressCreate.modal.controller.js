...
function AddressCreateModalController($timeout, $uibModalInstance, $exceptionHandler, $scope, sdkOrderCloud, ocGeography, SelectedBuyerID){
    var vm = this;
    vm.address = {
    ...
    vm.submit = function() {
        vm.loading = sdkOrderCloud.Addresses.Create(SelectedBuyerID, vm.address)
