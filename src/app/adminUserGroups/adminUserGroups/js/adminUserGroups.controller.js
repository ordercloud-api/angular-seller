...
function AdminUserGroupsController($q, $filter, $state, $uibModal, toastr, ocConfirm, OrderCloud, ocAdminUserGroups, OrderCloudParameters, AdminUserGroupList, Parameters){
    var vm = this;
